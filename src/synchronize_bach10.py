...
name = "bach-invention-10_26APril"

piece = converter.parse('Fugues/bach-invention-10.mid')
#piece.show('midi')
...
#[1 ,1, 1, -1, -1]
newPoint = numpy.sum([perturbPoint,[10,20, -50 , 20.5, -55]], axis = 0)
print(newPoint)
asp1 = []
asp2 = []
...
xdash = music_utils.getFirstNPoints(xd,N3)
for c in range(N3):
    print(c, xdash[c][1], xdash[c][3], xdash[c][2], xdash[c][4])
#
# si, sx = music_utils.sortedX(y1ref)
