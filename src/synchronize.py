...
piece = corpus.parse('bach/bwv244')
#piece.show('midi')
piece.write('midi', 'fugue1_bwv244.mid')
...
score.insert(0,on1)
score.insert(0,on2)
score.write('midi', 'sync_bwv244_ref.mid')
#fugue.show('midi')
...
N = 30
reftraj = music_utils.getRefCordinatesOfAttractor(music_utils.AttractorType.COUPLED_LORENZ, [1,0.5,0.5,1,1])
y1ref = reftraj[1]
y2ref = reftraj[3]
...
y1dash = reftraj[1][0:100]
y2dash = reftraj[3][0:100]
#print(pitches)
sp1 = []
sp2 = []
...
#score.show('midi')
score.write('midi', 'sync_bwv244_synchronized.mid')



# Perturbation
perturbPoint = reftraj[:,N-1]
newPoint = numpy.sum([perturbPoint,[0,0,0,2,-2]], axis = 0)
asp1 = []
asp2 = []
...
#score.show('midi')
score.write('midi', 'sync_bwv244_Async.mid')
...
#score.show('midi')
score.write('midi', 'sync+async_bwv244_Async.mid')
